...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /home/aya/src/Pico-Game-Controller-main/CMakeFiles /home/aya/src/Pico-Game-Controller-main//CMakeFiles/progress.marks
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /home/aya/src/Pico-Game-Controller-main/CMakeFiles 0
.PHONY : all
...
#=============================================================================
# Target rules for targets named Pico_Game_Controller

# Build rule for target.
Pico_Game_Controller: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 Pico_Game_Controller
.PHONY : Pico_Game_Controller

# fast build rule for target.
Pico_Game_Controller/fast:
	$(MAKE) $(MAKESILENT) -f src/CMakeFiles/Pico_Game_Controller.dir/build.make src/CMakeFiles/Pico_Game_Controller.dir/build
.PHONY : Pico_Game_Controller/fast

#=============================================================================
# Target rules for targets named Pico_Game_Controller_encoders_pio_h

# Build rule for target.
Pico_Game_Controller_encoders_pio_h: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 Pico_Game_Controller_encoders_pio_h
.PHONY : Pico_Game_Controller_encoders_pio_h

# fast build rule for target.
Pico_Game_Controller_encoders_pio_h/fast:
	$(MAKE) $(MAKESILENT) -f src/CMakeFiles/Pico_Game_Controller_encoders_pio_h.dir/build.make src/CMakeFiles/Pico_Game_Controller_encoders_pio_h.dir/build
.PHONY : Pico_Game_Controller_encoders_pio_h/fast

#=============================================================================
# Target rules for targets named Pico_Game_Controller_ws2812_pio_h

# Build rule for target.
Pico_Game_Controller_ws2812_pio_h: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 Pico_Game_Controller_ws2812_pio_h
.PHONY : Pico_Game_Controller_ws2812_pio_h

# fast build rule for target.
Pico_Game_Controller_ws2812_pio_h/fast:
	$(MAKE) $(MAKESILENT) -f src/CMakeFiles/Pico_Game_Controller_ws2812_pio_h.dir/build.make src/CMakeFiles/Pico_Game_Controller_ws2812_pio_h.dir/build
.PHONY : Pico_Game_Controller_ws2812_pio_h/fast
...
help:
	...
	@echo "... rebuild_cache"
	@echo "... ELF2UF2Build"
	@echo "... Pico_Game_Controller_encoders_pio_h"
	@echo "... Pico_Game_Controller_ws2812_pio_h"
	@echo "... PioasmBuild"
